...
switch (CFG_ENV) {
    ...
    case 'dev':
        ...
        define ('CFG_USER', 'root');        // User
        define ('CFG_PASS', '');        // Pass
        define ('CFG_BASE', 'betcraft');     // Base
    ...
    case 'prod':
        ...
        define ('CFG_BASE', 'carbone_v50');     // Base
...
define ('CFG_SESSION_LEVEL', '4');                                  // Mode de sécurité (champ de bit) : 1 = contrôle HTTP_USER_AGENT, 2 = session volatile, 4 = token de session (ie 0 = rien, 7 = tout, 3 = contrôle HTTP_USER_AGENT + session volatile)
...
define ('CFG_VERSION', '5.0.000 Beta 2');                                   // Version de l'application
define ('CFG_DATE', '19/02/2013');                                          // Date de dernières révision de l'application
