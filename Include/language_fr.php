...
define('STR_RUBRIQUE_ONGLET_DROIT', 'Droits d\'accès');
...
define('STR_FORM_E_FATAL_FIELD_SAISIE', 'Le champ &laquo;%s&raquo; n\'est pas saisie correctement');
...
define('STR_LOGIN_FIELDSET_RAPPEL', 'Rappel de votre mot de passe');
...
define('STR_LOGIN_E_WARNING', 'Votre mot de passe vient de vous être rappelé par mail !');
define('STR_LOGIN_EMAIL_SUJECT','Rappel de votre mot de passe !');
define('STR_LOGIN_EMAIL_BODY','Votre mot de passe pour la connexion est : %s');
define('STR_LOGIN_EMAIL_BODY_HTML','<font face=Arial size=2>Votre mot de passe pour la connexion est : <strong>%s</strong></font>');
...
define('STR_ACCUEIL_MESSAGE_1', 'Hydram Lernaeam Typhonis filiam cum capitibus nouem ad fontem Lernaeum interfecit. haec tantam uim ueneni habuit ut afflatu homines necaret, et si quis eam dormientem transierat, uestigia eius afflabat et maiori cruciatu moriebatur.');
...
define('STR_UTILISATEUR_LIBELLE_ACL', 'Rubriques autorisées');
...
define('STR_UTILISATEUR_LEGENDE_PASSWORD', 'Hydram Lernaeam Typhonis filiam cum capitibus nouem ad fontem Lernaeum interfecit. haec tantam uim ueneni habuit ut afflatu homines necaret, et si quis eam dormientem transierat, uestigia eius afflabat et maiori cruciatu moriebatur.');
...
define('STR_ONGLET_TITRE_ETAPE_2', 'Configuration des droits');
